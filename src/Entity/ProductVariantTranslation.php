...
#[ORM\Entity(repositoryClass: ProductVariantTranslationRepository::class)]
#[ORM\Table(name: 'product_variant_translations')]
#[ORM\UniqueConstraint(name: 'UNIQ_PRODUCT_VARIANT_LANGUAGE', columns: ['product_variant_id', 'language_id'])]
class ProductVariantTranslation
{
    ...
    #[ORM\ManyToOne(targetEntity: ProductVariant::class, inversedBy: 'translations')]
    ...
    {
        return ($this->name ?: 'Untitled Variant') . ' (' . $this->language?->getCode() . ')';
    }
}